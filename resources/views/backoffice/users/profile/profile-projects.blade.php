                ...
                <div class="col-md-12">
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('profile.teams') }}"
                          ><i class="icon-base ti tabler-users icon-sm me-1_5"></i> Teams</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" href="{{ route('profile.projects') }}"
                        ...
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0 z-2">
                            ...
                            <li
                              ...
                              title="Nurvi Karlos"
                              class="avatar avatar-sm pull-up me-3">
                              <img class="rounded-circle" src="/vuexy/assets/img/avatars/15.png" alt="Avatar" />
                            </li>
