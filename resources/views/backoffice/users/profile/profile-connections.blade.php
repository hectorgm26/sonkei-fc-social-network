                ...
                <div class="col-md-12">
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="{{ route('profile.connections') }}"
                  ...
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <div class="mx-auto my-6">
                        <img
                          src="/vuexy/assets/img/avatars/3.png"
                          alt="Avatar Image"
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <div class="mx-auto my-6">
                        <img
                          src="/vuexy/assets/img/avatars/12.png"
                          alt="Avatar Image"
                          class="rounded-circle w-px-100 h-px-100" />
                      </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <div class="mx-auto my-6">
                        <img
                          src="/vuexy/assets/img/avatars/5.png"
                          alt="Avatar Image"
                          class="rounded-circle w-px-100 h-px-100" />
                      </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <div class="mx-auto my-6">
                        <img
                          src="/vuexy/assets/img/avatars/8.png"
                          alt="Avatar Image"
                          class="rounded-circle w-px-100 h-px-100" />
                      </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <div class="mx-auto my-6">
                        <img
                          src="/vuexy/assets/img/avatars/9.png"
                          alt="Avatar Image"
                          class="rounded-circle w-px-100 h-px-100" />
                      </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                  <div class="card">
                    <div class="card-body text-center">
                      ...
                      <div class="mx-auto my-6">
                        <img
                          src="/vuexy/assets/img/avatars/10.png"
                          alt="Avatar Image"
                          class="rounded-circle w-px-100 h-px-100" />
                      </div>
