                ...
                <li class="menu-item active open">
                  ...
                  <ul class="menu-sub">
                    ...
                    <li class="menu-item active">
                      <a href="{{ route('profile.teams') }}" class="menu-link">
                        <div data-i18n="Teams">Teams</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="{{ route('profile.projects') }}" class="menu-link">
                        <div data-i18n="Projects">Projects</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="{{ route('profile.connections') }}" class="menu-link">
                        <div data-i18n="Connections">Connections</div>
                      </a>
                    </li>
                  </ul>
                ...
                <div class="col-md-12">
                  <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-sm-row mb-6 gap-sm-0 gap-2">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" href="{{ route('profile.teams') }}"
                          ><i class="icon-base ti tabler-users icon-sm me-1_5"></i> Teams</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('profile.projects') }}"
                          ><i class="icon-base ti tabler-layout-grid icon-sm me-1_5"></i> Projects</a
                        >
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="{{ route('profile.connections') }}"
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3 pb-1">
                        <a href="javascript:;" class="d-flex align-items-center">
                          <div class="avatar me-2">
                            <img src="/vuexy/assets/img/icons/brands/xd-label.png" alt="Avatar" class="rounded-circle" />
                          </div>
                        ...
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                            ...
                            <li
                              ...
                              title="Danny Paul"
                              class="avatar avatar-sm pull-up">
                              <img class="rounded-circle" src="/vuexy/assets/img/avatars/7.png" alt="Avatar" />
                            </li>
                            <li class="avatar avatar-sm">
                              <span
                                class="avatar-initial rounded-circle pull-up"
                        ...
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                            ...
                            <li
                              ...
                              title="Rishi Swaat"
                              class="avatar avatar-sm pull-up">
                              <img class="rounded-circle" src="/vuexy/assets/img/avatars/9.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3 pb-1">
                        <a href="javascript:;" class="d-flex align-items-center">
                          <div class="avatar me-2">
                            <img
                              src="/vuexy/assets/img/icons/brands/social-label.png"
                              alt="Avatar"
                              class="rounded-circle" />
                          </div>
                        ...
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                            <li
                              ...
                              title="Kim Merchent"
                              class="avatar avatar-sm pull-up">
                              <img class="rounded-circle" src="/vuexy/assets/img/avatars/10.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                              ...
                              title="Sam D'souza"
                              class="avatar avatar-sm pull-up">
                              <img class="rounded-circle" src="/vuexy/assets/img/avatars/13.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3 pb-1">
                        <a href="javascript:;" class="d-flex align-items-center">
                          <div class="avatar me-2">
                            <img
                              src="/vuexy/assets/img/icons/brands/event-label.png"
                              alt="Avatar"
                              class="rounded-circle" />
                          </div>
                        ...
                        <div class="d-flex align-items-center">
                          <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                            ...
                            <li
                              ...
                              title="Allen Rieske"
                              class="avatar avatar-sm pull-up">
                              <img class="rounded-circle" src="/vuexy/assets/img/avatars/8.png" alt="Avatar" />
                            </li>
                            <li
                              data-bs-toggle="tooltip"
                              data-popup="tooltip-custom"
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-center mb-3 pb-1">
                        <a href="javascript:;" class="d-flex align-items-center">
                          <div class="avatar me-2">
                            <img
                              src="/vuexy/assets/img/icons/brands/html-label.png"
                              alt="Avatar"
                              class="rounded-circle" />
                          </div>
